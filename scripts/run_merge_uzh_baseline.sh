...
python $CODE_DIR/pipeline/organize_uzh.py --lemmas $DATA_DIR/$2.V-$1 --uzh-train $TMP_DIR/$2/uzh.train --uzh-dev $TMP_DIR/$2/uzh.dev --uzh-test-pred $TMP_DIR/$2/uzh_results/f.beam4.test.predictions --output $OUTPUT_DIR/merge_uzh/$2.V-$1.output --verbose
python $CODE_DIR/evaluate.py $DATA_DIR/$2.V-$1.gold $OUTPUT_DIR/merge_uzh/$2.V-$1.output
